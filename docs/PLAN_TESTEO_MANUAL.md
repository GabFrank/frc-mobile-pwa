...
⚠️ **Lo que NO tiene que pasar:** que baje un PNG y no abra nada. En el
escritorio `navigator.share` no existe, y la primera versión de esto caía en
una descarga — el usuario veía «genera una imagen» y ningún WhatsApp.
