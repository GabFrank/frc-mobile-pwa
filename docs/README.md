...
| **[trampas-de-angular.md](arquitectura/trampas-de-angular.md)** | **Vigente.** Cosas que no fallan pero hacen otra cosa: `mat-select` con `null`, NG8011, `serviceWorker.ready` |
