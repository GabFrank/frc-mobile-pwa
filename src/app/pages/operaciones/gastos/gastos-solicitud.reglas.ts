...
export function faltaParaGuardar(datos: DatosSolicitud): string | null {
  ...
  // que es un id válido y a la vez un valor "falsy". Con `!` quedaría marcada
  // como sin elegir aunque estuviera seleccionada y visible. Y ahora SERVIDOR
  // sí se puede elegir (un gasto dirigido al central se cobra desde la caja
  // mayor), así que la trampa está viva, no es teórica.
